...
CREATURE_DIR = "./ressource/creature"
...
def get_all_creature_modes():
    result = []
    prefix = "%s_" % Creature.DEFAULT_CONFIG["file_name_prefix"]
    suffix = ".svg"
...
class Randolph(Creature):
    pass  # Nothing more than an alternative name


class Mortimer(Creature):
    CONFIG = {
        "color": GREY_BROWN,
        "flip_at_start": True,
    }
...
class Mathematician(Creature):
    CONFIG = {
        "color": GREY,
    }


class BabyCreature(Creature):
    CONFIG = {
        "scale_factor": 0.5,
...
class TauCreature(Creature):
    CONFIG = {
        "file_name_prefix": "TauCreatures"
    }


class ThreeLeggedCreature(Creature):
    CONFIG = {
        "file_name_prefix": "ThreeLeggedCreatures"
    }
